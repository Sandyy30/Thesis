...
parser.add_argument('--annotation', type=str, default='./data/iu_xray/annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default='./data/iu_xray/images', help="base dir to help find images")
