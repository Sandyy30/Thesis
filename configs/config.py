...
parser.add_argument('--annotation', type=str, default='/kaggle/working/Thesis/data/iu_xray/annotation.json', help="annotation file of the dataset")
parser.add_argument('--base_dir', type=str, default='/kaggle/working/Thesis/data/iu_xray/images', help="base dir to help find images")
...
parser.add_argument('--strategy', type=str, default="auto", help='let lightning choose strategy based on available hardware')
...
parser.add_argument('--max_epochs', type=int, default=1, help='Stop training once this number of epochs is reached')
